...
class Yoast_Form {
	...
	public function textarea( $var, $label, $attr = [] ) {
		...
		$this->label( $label . ':', [ 'for' => $var, 'class' => 'textinput' ] );
	...
	public function select( $var, $label, $values ) {
		...
		$this->label( $label . ':', [ 'for' => $var, 'class' => 'select' ] );
	...
	public function media_input( $var, $label ) {
		...
		$this->label( $label . ':', [ 'for' => 'wpseo_' . $var, 'class' => 'select' ] );
	...
	public function radio( $var, $values, $label ) {
		...
		foreach ( $values as $key => $value ) {
			...
			$this->label( $value, [ 'for' => $var_esc . '-' . $key_esc, 'class' => 'radio' ] );
		}
