...
?>
	...
	<div class="tabwrapper">
		...
		<div id="post_types" class="wpseotab">
			...
			if ( is_array( $post_types ) && $post_types !== [ ] ) {
				foreach ( $post_types as $pt ) {
					...
					$yform->textarea( 'metadesc-' . $name, __( 'Meta description template', 'wordpress-seo' ), [ 'class' => 'template posttype-template' ] );
					if ( $options[ 'usemetakeywords' ] === true ) {
			...
			$post_types = get_post_types( [ '_builtin' => false, 'has_archive' => true ], 'objects' );
			if ( is_array( $post_types ) && $post_types !== [ ] ) {
				...
				foreach ( $post_types as $pt ) {
					...
					$yform->textarea( 'metadesc-ptarchive-' . $name, __( 'Meta description', 'wordpress-seo' ), [ 'class' => 'template posttype-template' ] );
					if ( $options[ 'usemetakeywords' ] === true ) {
		...
		<div id="taxonomies" class="wpseotab">
			...
			if ( is_array( $taxonomies ) && $taxonomies !== [ ] ) {
				foreach ( $taxonomies as $tax ) {
					...
					$yform->textarea( 'metadesc-tax-' . $tax->name, __( 'Meta description template', 'wordpress-seo' ), [ 'class' => 'template taxonomy-template' ] );
					if ( $options[ 'usemetakeywords' ] === true ) {
		...
		<div id="archives" class="wpseotab">
			...
			$yform->textarea( 'metadesc-author-wpseo', __( 'Meta description template', 'wordpress-seo' ), [ 'class' => 'template author-template' ] );
			if ( $options[ 'usemetakeywords' ] === true ) {
			...
			$yform->textarea( 'metadesc-archive-wpseo', __( 'Meta description template', 'wordpress-seo' ), [ 'class' => 'template date-template' ] );
			echo '<br/>';
