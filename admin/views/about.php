...
<div class="wrap about-wrap">
	...
	<p class="about-text">
		Yoast SEO 2.3 helps you optimize your site showing you errors straight from Google Search Console, and pointing
		you at posts that need work.
	</p>
		...
		<div class="headline-feature">
			...
			<div class="feature-section">
				<div class="col">
					...
					<p>
						If you have <a target="_blank"
						               href="https://yoast.com/wordpress/plugins/seo-premium/#utm_source=wordpress-seo-config&utm_medium=textlink&utm_campaign=about-page">Yoast
							SEO Premium</a>, you'll even be able to fix those errors by redirecting the broken
		...
		<div class="headline-feature">
			<div class="feature-section">
				...
				<div class="col">
					...
					<p>
						Don't know how to optimize your posts? Read our <a target="_blank"
						                                                   href="https://yoast.com/ebooks/content-seo/#utm_source=wordpress-seo-config&utm_medium=textlink&utm_campaign=about-page">Content
							SEO eBook</a>!
					</p>
				</div>
			</div>
		...
		<div class="headline-feature">
			<div class="feature-section">
				<div class="col">
					...
					<p>
						Are you a developer? Learn <a
							href='http://kb.yoast.com/article/274-add-theme-support-for-yoast-seo-breadcrumbs'>how
	...
	<div id="credits" class="wpseotab">
		...
		?>
		<p>We're always grateful for patches from non-regular contributors, in Yoast SEO 2.2 and 2.3, patches from the
