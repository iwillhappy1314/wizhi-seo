...
class WPSEO_Option_Titles extends WPSEO_Option {
	...
	/**
	 * @var array Array of the separator options. To get these options use
	...
	public function enrich_defaults() {
		...
		$post_type_objects_custom = get_post_types( [ 'public' => true, '_builtin' => false ], 'objects' );
	...
	protected function clean_option( $option_value, $current_version = null, $all_old_option_values = null ) {
		...
		if ( ! isset( $original ) && has_action( 'wpseo_double_clean_titles', [
				$this,
				'clean',
			] ) === false
		) {
