 ...
 *        wpseo_register_var_replacement( '%%myvar1%%', 'retrieve_var1_replacement', 'advanced', 'this is a help text
 *        for myvar1' ); wpseo_register_var_replacement( 'myvar2', array( 'class', 'method_name' ), 'basic', 'this is a
 *        help text for myvar2' );
 * }
...
function wpseo_ping_search_engines( $sitemapurl = null ) {
	...
	wp_remote_get( 'http://www.google.com/webmasters/tools/ping?sitemap=' . $sitemapurl, [ 'blocking' => false ] );
	wp_remote_get( 'http://www.bing.com/ping?sitemap=' . $sitemapurl, [ 'blocking' => false ] );
}
 ...
 * It adds new keys to a wpml-config.xml file for a custom post type title, metadesc, title-ptarchive and
 * metadesc-ptarchive fields translation. Documentation:
