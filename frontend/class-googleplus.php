...
class WPSEO_GooglePlus {
	...
	public function __construct() {
		add_action( 'wpseo_googleplus', [ $this, 'google_plus_title' ], 10 );
		add_action( 'wpseo_googleplus', [ $this, 'description' ], 11 );
		add_action( 'wpseo_googleplus', [ $this, 'google_plus_image' ], 12 );

		add_action( 'wpseo_head', [ $this, 'output' ], 40 );
	}
