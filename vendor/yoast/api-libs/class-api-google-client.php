...
class Yoast_Api_Google_Client extends Yoast_Google_Client {
	...
	private function get_access_token() {
		return get_option( $this->option_access_token, [ 'access_token' => false, 'expires' => 0 ] );
	}
	...
	public function do_request( $target_request_url, $decode_response = false, $request_method = 'GET' ) {
		// Get response.
		$response = $this->getIo()
		                 ->authenticatedRequest( new Yoast_Google_HttpRequest( $this->api_url . $target_request_url, $request_method ) );
